...
public class VetriNichaiyam {
 	...
 	driver.findElement(By.xpath("//.//*[@id='identifierId']")).sendKeys(worksheet.getRow(1).getCell(1).getStringCellValue());
 	driver.findElement(By.cssSelector("span.RveJvd.snByac")).click();
 	 
 	
 	driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
 	String s=String.valueOf(worksheet.getRow(1).getCell(1));
    driver.findElement(By.xpath("//.//*[@id='password']/div[1]/div/div[1]/input")).sendKeys(s);
    driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
     Thread.sleep(1000);
